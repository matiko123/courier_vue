                  ...
                  <form>
                    <div class="row">
                      ...
                      <div class="col-xl-2 col-md-3 col-sm-6">
                        <div class="col-auto">
                          <div class="input-group mb-2">
                            <multiselect v-model="selectedAgent" :options="agents" :searchable="true" placeholder="Select Agent" label="label" track-by="value"></multiselect>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-xl-6 col-md-3 col-sm-6">
                        <div class="buttons p-2">
                          ...
                          <button class="btn btn-primary me-2" @click.prevent="fetchData" :disabled="loading">
  ...
  methods: {
    ...
    fetchAgents(officeId) {
      axiosInstance
        ...
        .then((response) => {
          ...
          console.log('Agents fetched:', this.agents);
        })
        .catch((error) => {
    ...
    async fetchData() {
      try {
        ...
        const params = {
          ...
          agent_id: this.selectedAgent ? this.selectedAgent.value : 'ALL', 
        };
    ...
    async printData() {
      try {
        ...
        const url = `${axiosInstance.defaults.baseURL}reports/sales-pdf?${params}`;
        if (url) {
